...
headers = {
    "Authorization": "Bearer xai-njSzSkkrD7Rqm6JCYlcoD5V4I86LhltqDxXJkS6edvd36FZjDikmBHXKtnmkGJ9xNe1AqRM4PMdk5Dp7",
...
def start_chat():
    ...
    def send_message(event=None):
        ...
        if response.status_code == 200:
            ...
            chat_display.insert(tk.END, f"{response.status_code}, {response.text}\n\n")
            chat_display.config(state="disabled")
